...
public:
    ...
    MutexPair<std::vector<Chunk*>> dataFromBlockTypeWorkerThreads;
    std::vector<Chunk*> dataToVBOWorkerThreads;
    MutexPair<std::vector<ChunkVBOdata>> dataFromVBOWorkerThreads;
    std::mutex dataToBlockTypeWorkerThreadsMutex;
    std::mutex dataToVBOWorkerThreadsMutex;
